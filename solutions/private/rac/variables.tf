...
variable "pi_placement_group_name" {
  description = "Existing Power Virtual Server placement group."
  type        = string
  default     = "oracle-rac-affinity"
}
...
// TODO : New param cos_oracle_cluvfy_file_path
...
# 4. GIMR diskgroup
variable "pi_gimr_volume" {
  description = "Disk configuration for ASM"
  type = object({
    name  = optional(string, "GIMR")
    size  = string
    count = string
    tier  = string
  })
...
// TODO : Place Rac params befor db creds
#####################################################
# RAC Params
#####################################################

variable "rac_nodes" {
  description = "Number of oracle instance nodes"
  type        = number
  default     = 2
}
...
// TODO : Drop down  with values 19.15 ..... 19.29
